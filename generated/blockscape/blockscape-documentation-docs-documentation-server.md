---
type: BlockscapeDocs
title: Local backend (`server.js`)
id: blockscape-documentation-docs-documentation-server
source_file: ../human/blockscape/documentation/docs/documentation/server.md
